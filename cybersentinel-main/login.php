...
if( isset( $_POST[ 'Login' ] ) ) {
	...
	$query_users  = "SELECT * FROM `users` WHERE username='$user' AND password='$pass';";
	...
	$query_old  = "SELECT * FROM `old_users` WHERE old_username='$user' AND old_password='$pass';";
	mysqli_select_db($GLOBALS["___mysqli_ston"],  $_SENTINEL[ 'db_database' ] );
...
<html lang=\"en-GB\">
	...
	<div id=\"footer\">
	<p>" . sentinelExternalLinkUrlGet( 'https://github.com/srishanthkumar97', 'Cyber Sentinel' ) . "</p>
	</div> <!--<div id=\"footer\"> -->
	</div> <!--<div id=\"wrapper\"> -->
	</body>
</html>";
