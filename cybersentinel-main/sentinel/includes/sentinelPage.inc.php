...
function sentinelLoggedUserCheck($check_user) {
    ...
    // Perform the query
    $query = "SELECT COUNT(*) as count FROM users WHERE username = '$check_user'";
...
<!-- JavaScript function to handle user deletion -->
	...
	<body class=\"home\">
		<div id=\"container\"><!-- container div start-->
			...
			<div id=\"footer\">
				<p><a style=\"font-size: 13px; background: black;\" href=\"https://github.com/srishanthkumar97\" target=\"_blank\" rel=\"nofollow noreferrer noopener\">
